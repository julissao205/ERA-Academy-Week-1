...
// POST /students - recieves new student data and inserts into mysql
...
// POST /login - checks email and pasword against the users table
app.post("/login", (req, res) => {
    ...
    const specialChar = /[!@#$%]/;
    if (!specialChar.test(password)) {
        return res.status(400).json({ error: "password must inculde at least 1 special character: ! @ # $ %"});
    }
